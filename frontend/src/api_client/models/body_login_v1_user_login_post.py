...
T = TypeVar("T", bound="BodyLoginV1UserLoginPost")


@_attrs_define
class BodyLoginV1UserLoginPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        body_login_v1_user_login_post = cls(
            username=username,
            password=password,
        ...
        body_login_v1_user_login_post.additional_properties = d
        return body_login_v1_user_login_post
