...
from dash import Input, Output, State, html, dash_table, dcc, callback
...
layout = dbc.Container([
        dbc.Row([
                dbc.Col(html.Div([
                    ...
                    dcc.Dropdown([model.name for model in models.models], models.models[0].name, id='model-dropdown'),
                    # Submit button
...
def update_predictions_table(n_clicks):
...
def submit_prediction_data(n_clicks, input_data, model_name):
