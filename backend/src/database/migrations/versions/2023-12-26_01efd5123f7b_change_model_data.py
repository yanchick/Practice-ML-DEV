...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "prediction_class_prediction_fkey", "prediction", "prediction_class", ["predicted_class_id"], ["id"]
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "prediction",
        sa.Column("output", postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),  # type: ignore[no-untyped-call]
    )
    op.add_column(
        "prediction",
        sa.Column("input", postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),  # type: ignore[no-untyped-call]
    )
