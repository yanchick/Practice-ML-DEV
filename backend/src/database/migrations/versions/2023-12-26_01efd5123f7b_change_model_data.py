...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "prediction", sa.Column("output", postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False)  # type: ignore[no-untyped-call]
    )
    op.add_column(
        "prediction", sa.Column("input", postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False)  # type: ignore[no-untyped-call]
    )
