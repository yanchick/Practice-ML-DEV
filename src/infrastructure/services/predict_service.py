...
from infrastructure.repository.models_repository import ModelsRepository
from inference.task import predict, q
...
class PredictionService:
    ...
    async def register_prediction(self, user_id: int, model: str, **kwargs):
        ...
        if db_user.balance < db_model.cost:
            raise DuplicatedError(detail="Not enough coins")
